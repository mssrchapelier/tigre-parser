...
class CellRootTemplate {
	...
	private CellRootTemplate (char[] vowelPattern, boolean[] geminationPattern, String rootGrammemeGloss) {
		this.vowelPattern = vowelPattern;
		this.geminationPattern = geminationPattern;
		this.rootGrammemeGloss = rootGrammemeGloss;
	}

	MorphemeAnalysis applyTo (Stem stem) {
	...
	static CellRootTemplate parseAndBuild (String surface, String rootGrammemeGloss) throws ConfigParseException {
		...
		return new CellRootTemplate(vowelPattern, gemPattern, rootGrammemeGloss);
	}
}
