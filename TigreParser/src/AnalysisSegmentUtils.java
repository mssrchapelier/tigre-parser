...
final class AnalysisSegmentUtils {

	private AnalysisSegmentUtils () {}

	static AnalysisSegment makeCopy (AnalysisSegment inputSegment) {
	...
	static ArrayList<AnalysisSegment> cloneList (ArrayList<? extends AnalysisSegment> inputList) {
