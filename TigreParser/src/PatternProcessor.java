...
public class PatternProcessor {
	...
	public ArrayList<WordAnalysis> processWord (final String geminatedOrtho) {
	...
	public static class PatternProcessorBuilder {
		...
		public PatternProcessorBuilder readFrom (String[] patternFilePaths) throws IOException, ConfigParseException {
			try {
