...
class Paradigm {
	...
	private Paradigm (LinkedHashMap<StemDescription, ArrayList<ParadigmCell>> paradigm) {
	...
	static class ParadigmBuilder {
		...
		Paradigm build () {
			return new Paradigm(this.getParadigmAsLists());
		}
		
		ParadigmBuilder readFrom (InputStream inputStream) throws IOException, ConfigParseException {
